...
class HTMLSentenceTokenizer:
    ...
    def handle_end_of_string(self):
        ...
        #self.current_string = self.current_string.replace(WINDOWS_LINE_ENDING,UNIX_LINE_ENDING) 
        doc = nlp(self.current_string)
        current_sentences = [s.text for s in doc.sents]
