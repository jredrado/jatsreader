...
pub mod __batch__;
pub mod resourceverifier; // resourceverifier

#[allow(unused)]
static ALL_COMPONENTS: &[&str] = &["resourceverifier"];
    ...
    fn dispatch(&self, op: &'static str, payload: &'static [u8]) -> CallResult {
        Box::pin(async move {
            let (mut stream, id) = match op {
                "resourceverifier" => {
                    crate::components::generated::resourceverifier::Component::default()
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
    ...
    components.insert(
        "resourceverifier".to_owned(),
        generated::resourceverifier::signature(),
    );

    wasmflow_sdk::v1::types::CollectionSignature {
        name: Some("resourceverifier".to_owned()),
...
pub mod generated {
    ...
    // start component resourceverifier
    pub mod resourceverifier {
        // The user-facing implementation job impl.
        use crate::components::resourceverifier as implementation;

        // The generated definition of inputs, outputs, config, et al.
        use super::resourceverifier as definition;
        // The generated integration code between the definition and the implementation.
        use super::resourceverifier as integration;
        ...
        pub fn signature() -> wasmflow_sdk::v1::types::ComponentSignature {
            wasmflow_sdk::v1::types::ComponentSignature {
                name: "resourceverifier".to_owned(),
        ...
        pub fn convert_inputs(
            ...
            Ok(definition::Inputs {
                ...
                path: payload
                    .remove("path")
                    .ok_or_else(|| wasmflow_sdk::v1::error::Error::MissingInput("path".to_owned()))?
                    .deserialize()?,
                proofs: payload
                    .remove("proofs")
                    .ok_or_else(|| {
        ...
        pub fn convert_inputs(
            ...
            Ok(definition::Inputs {
                ...
                path: wasmflow_sdk::v1::codec::messagepack::deserialize(payload.get("path")?)?,
        ...
        impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
            fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
                ...
                map.insert(
                    "path".to_owned(),
                    wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.path).into(),
                );
                map.insert(
                    "proofs".to_owned(),
    ...
    // end component resourceverifier
    ...
    pub mod __batch__ {
        ...
        pub enum ComponentInputs {
            Resourceverifier(super::resourceverifier::Inputs),
        }

        #[cfg(all(feature = "guest"))]
        #[allow(missing_debug_implementations)]
        pub enum ComponentOutputs {
            Resourceverifier(super::resourceverifier::Outputs),
        }

        #[derive(Debug, serde::Deserialize)]
        pub enum Config {
            Resourceverifier(super::resourceverifier::Config),
        }
