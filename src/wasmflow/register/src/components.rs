...
pub(crate) extern "C" fn wapc_init() {
  wasmflow_sdk::v1::wasm::runtime::register_dispatcher(Box::new(ComponentDispatcher::default()));
    ...
    pub mod filereader; // filereader
    pub mod register; // register
pub mod __batch__;
  ...
  fn dispatch(
    ...
    Box::pin(async move {
      let (mut stream, id) = match op {
          "filereader" => crate::components::generated::filereader::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, ).await,
          "register" => crate::components::generated::register::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, ).await,
...
impl wasmflow_sdk::v1::ephemeral::NativeDispatcher for ComponentDispatcher {
    ...
    > {
      ...
      let (stream, _id) = match invocation.target.name() {
          "filereader" => crate::components::generated::filereader::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, ).await,
          "register" => crate::components::generated::register::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, ).await,
        "__batch__" => {
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
  let mut components:std::collections::HashMap<String, wasmflow_sdk::v1::types::ComponentSignature> = std::collections::HashMap::new();
    ...
    components.insert("filereader".to_owned(), generated::filereader::signature());
    components.insert("register".to_owned(), generated::register::signature());
...
pub mod generated {
      ...
      pub mod filereader {
        ...
        pub fn convert_inputs(mut payload:wasmflow_sdk::v1::packet::v1::PacketMap) -> Result<definition::Inputs,Box<dyn std::error::Error + Send + Sync>> {
          Ok(definition::Inputs {
              filename: payload.remove("filename").ok_or_else(||wasmflow_sdk::v1::error::Error::MissingInput("filename".to_owned()))?.deserialize()?,
          })
        }
        ...
        impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
          fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
            let mut map = std::collections::HashMap::default();
              map.insert("filename".to_owned(), wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.filename).into());
        ...
        impl Outputs {
            pub async fn contents(&mut self)-> Result<wasmflow_sdk::v1::PortOutput<
      ...
      // end component filereader
      // start component register
      pub mod register {
          // The user-facing implementation job impl.
          use crate::components::register as implementation;
  
        // The generated definition of inputs, outputs, config, et al.
        use super::register as definition;
        // The generated integration code between the definition and the implementation.
        use super::register as integration;
        ...
        pub fn convert_inputs(mut payload:wasmflow_sdk::v1::packet::v1::PacketMap) -> Result<definition::Inputs,Box<dyn std::error::Error + Send + Sync>> {
          Ok(definition::Inputs {
              ...
              name: payload.remove("name").ok_or_else(||wasmflow_sdk::v1::error::Error::MissingInput("name".to_owned()))?.deserialize()?,
          })
        }
        ...
        impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
          fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
            let mut map = std::collections::HashMap::default();
              ...
              map.insert("name".to_owned(), wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.name).into());
            wasmflow_sdk::v1::packet::PacketMap::new(map)
          }
        }
        ...
        impl Outputs {
            pub async fn id(&mut self)-> Result<wasmflow_sdk::v1::PortOutput<
          ...
          >, wasmflow_sdk::v1::error::Error> {
            ...
            pub async fn value(&mut self)-> Result<wasmflow_sdk::v1::PortOutput<
  ...
  pub mod __batch__ {
    ...
    pub enum ComponentInputs {
        Filereader(super::filereader::Inputs),
        Register(super::register::Inputs),
    }
  
    #[cfg(all(feature = "guest"))]
    #[allow(missing_debug_implementations)]
    pub enum ComponentOutputs {
        Filereader(super::filereader::Outputs),
        Register(super::register::Outputs),
    }
  
    #[derive(Debug, serde::Deserialize)]
    pub enum Config {
        Filereader(super::filereader::Config),
        Register(super::register::Config),
    }
