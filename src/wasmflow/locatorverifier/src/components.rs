...
pub mod __batch__;
pub mod locatorverifier; // locatorverifier

#[allow(unused)]
static ALL_COMPONENTS: &[&str] = &["locatorverifier"];
    ...
    fn dispatch(&self, op: &'static str, payload: &'static [u8]) -> CallResult {
        Box::pin(async move {
            let (mut stream, id) = match op {
                "locatorverifier" => {
                    crate::components::generated::locatorverifier::Component::default()
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
    ...
    components.insert(
        "locatorverifier".to_owned(),
        generated::locatorverifier::signature(),
    );
...
pub mod generated {
    ...
    // start component locatorverifier
    pub mod locatorverifier {
        // The user-facing implementation job impl.
        use crate::components::locatorverifier as implementation;

        // The generated definition of inputs, outputs, config, et al.
        use super::locatorverifier as definition;
        // The generated integration code between the definition and the implementation.
        use super::locatorverifier as integration;
    ...
    pub mod __batch__ {
        ...
        pub enum ComponentInputs {
            Locatorverifier(super::locatorverifier::Inputs),
        }

        #[cfg(all(feature = "guest"))]
        #[allow(missing_debug_implementations)]
        pub enum ComponentOutputs {
            Locatorverifier(super::locatorverifier::Outputs),
        }

        #[derive(Debug, serde::Deserialize)]
        pub enum Config {
            Locatorverifier(super::locatorverifier::Config),
        }
