...
pub mod __batch__;
pub mod resource; // resource

#[allow(unused)]
static ALL_COMPONENTS: &[&str] = &["resource"];
    ...
    fn dispatch(&self, op: &'static str, payload: &'static [u8]) -> CallResult {
        Box::pin(async move {
            let (mut stream, id) = match op {
                "resource" => {
                    crate::components::generated::resource::Component::default()
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
    ...
    components.insert("resource".to_owned(), generated::resource::signature());
...
pub mod generated {
    ...
    pub mod __batch__ {
        ...
        pub enum ComponentInputs {
            Resource(super::resource::Inputs),
        }

        #[cfg(all(feature = "guest"))]
        #[allow(missing_debug_implementations)]
        pub enum ComponentOutputs {
            Resource(super::resource::Outputs),
        }

        #[derive(Debug, serde::Deserialize)]
        pub enum Config {
            Resource(super::resource::Config),
        }
