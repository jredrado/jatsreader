...
pub(crate) extern "C" fn wapc_init() {
  wasmflow_sdk::v1::wasm::runtime::register_dispatcher(Box::new(ComponentDispatcher::default()));
    ...
    pub mod decode; // decode
    pub mod encode; // encode
pub mod __batch__;
  ...
  fn dispatch(
    ...
    Box::pin(async move {
      let (mut stream, id) = match op {
          "decode" => crate::components::generated::decode::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, ).await,
          "encode" => crate::components::generated::encode::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, ).await,
...
impl wasmflow_sdk::v1::ephemeral::NativeDispatcher for ComponentDispatcher {
    ...
    > {
      ...
      let (stream, _id) = match invocation.target.name() {
          "decode" => crate::components::generated::decode::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, ).await,
          "encode" => crate::components::generated::encode::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, ).await,
        "__batch__" => {
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
  let mut components:std::collections::HashMap<String, wasmflow_sdk::v1::types::ComponentSignature> = std::collections::HashMap::new();
    ...
    components.insert("decode".to_owned(), generated::decode::signature());
    components.insert("encode".to_owned(), generated::encode::signature());


  wasmflow_sdk::v1::types::CollectionSignature {
    name: Some("hex".to_owned()),
...
pub mod generated {
      ...
      // start component encode
      pub mod encode {
          // The user-facing implementation job impl.
          use crate::components::encode as implementation;
  
        // The generated definition of inputs, outputs, config, et al.
        use super::encode as definition;
        // The generated integration code between the definition and the implementation.
        use super::encode as integration;
  ...
  pub mod __batch__ {
    ...
    pub enum ComponentInputs {
        Decode(super::decode::Inputs),
        Encode(super::encode::Inputs),
    }
  
    #[cfg(all(feature = "guest"))]
    #[allow(missing_debug_implementations)]
    pub enum ComponentOutputs {
        Decode(super::decode::Outputs),
        Encode(super::encode::Outputs),
    }
  
    #[derive(Debug, serde::Deserialize)]
    pub enum Config {
        Decode(super::decode::Config),
        Encode(super::encode::Config),
    }
