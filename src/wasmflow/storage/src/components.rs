  ...
  fn dispatch(
    ...
    Box::pin(async move {
      let (mut stream, id) = match op {
          "get" => crate::components::generated::get::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, context,).await,
          "put" => crate::components::generated::put::Component::default().execute(wasmflow_sdk::v1::payload::from_buffer(payload)?, context,).await,
...
impl wasmflow_sdk::v1::stateful::NativeDispatcher for ComponentDispatcher {
    ...
    > {
      ...
      let (stream, _id) = match invocation.target.name() {
          "get" => crate::components::generated::get::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, context,).await,
          "put" => crate::components::generated::put::Component::default().execute(wasmflow_sdk::v1::payload::from_invocation(invocation)?, context,).await,
        "__batch__" => {
...
pub fn get_signature() -> wasmflow_sdk::v1::types::CollectionSignature {
  let mut components:std::collections::HashMap<String, wasmflow_sdk::v1::types::ComponentSignature> = std::collections::HashMap::new();
    ...
    components.insert("get".to_owned(), generated::get::signature());
    components.insert("put".to_owned(), generated::put::signature());


  wasmflow_sdk::v1::types::CollectionSignature {
    name: Some("storage".to_owned()),
...
pub mod generated {
      ...
      pub mod get {
        ...
        pub fn convert_inputs(mut payload:wasmflow_sdk::v1::packet::v1::PacketMap) -> Result<definition::Inputs,Box<dyn std::error::Error + Send + Sync>> {
          Ok(definition::Inputs {
              key: payload.remove("key").ok_or_else(||wasmflow_sdk::v1::error::Error::MissingInput("key".to_owned()))?.deserialize()?,
          })
        }
        ...
        impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
          fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
            let mut map = std::collections::HashMap::default();
              map.insert("key".to_owned(), wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.key).into());
      ...
      pub mod put {
          // The user-facing implementation job impl.
          use crate::components::put as implementation;
  
        // The generated definition of inputs, outputs, config, et al.
        use super::put as definition;
        // The generated integration code between the definition and the implementation.
        use super::put as integration;
        ...
        pub fn convert_inputs(mut payload:wasmflow_sdk::v1::packet::v1::PacketMap) -> Result<definition::Inputs,Box<dyn std::error::Error + Send + Sync>> {
          Ok(definition::Inputs {
              key: payload.remove("key").ok_or_else(||wasmflow_sdk::v1::error::Error::MissingInput("key".to_owned()))?.deserialize()?,
              value: payload.remove("value").ok_or_else(||wasmflow_sdk::v1::error::Error::MissingInput("value".to_owned()))?.deserialize()?,
          })
        }
        ...
        impl From<Inputs> for wasmflow_sdk::v1::packet::PacketMap {
          fn from(inputs: Inputs) -> wasmflow_sdk::v1::packet::PacketMap {
            let mut map = std::collections::HashMap::default();
              map.insert("key".to_owned(), wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.key).into());
              map.insert("value".to_owned(), wasmflow_sdk::v1::packet::v1::Packet::success(&inputs.value).into());
            wasmflow_sdk::v1::packet::PacketMap::new(map)
          }
        }
  ...
  pub mod __batch__ {
    ...
    pub enum ComponentInputs {
        Get(super::get::Inputs),
        Put(super::put::Inputs),
    }
  
    #[cfg(all(feature = "guest"))]
    #[allow(missing_debug_implementations)]
    pub enum ComponentOutputs {
        Get(super::get::Outputs),
        Put(super::put::Outputs),
    }
  
    #[derive(Debug, serde::Deserialize)]
    pub enum Config {
        Get(super::get::Config),
        Put(super::put::Config),
    }
