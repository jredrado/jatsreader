...
pub struct ResourceVerifierClient {
...
impl ResourceVerifierClient {
    ...
    pub fn resource(&self,id:String,path:Vec<u8>) -> Result<(Option<String>,Vec<u8>)> {

        let request = Request::ResourceVerifier(id,path);
